	...
	return (
		<section className="section experience">
			...
			<article className="flex-item">
				...
				<h4>Tradeling</h4>
				<ul>
					<li>Tradeling is the leading B2B E-commerce Marketplace in the MENA region.</li>
			...
			<article className="flex-item">
				...
				<ul>
					<li>
						I was on the TAMM Project In Abu Dhabi. It is a digital transformation project aiming to revolutionise how citizens of Abu
