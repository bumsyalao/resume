		...
		<section className="section">
			...
			{/* <div className="flex"> */}
				<article className="flex-item">
					...
					<p>Built an asset tracking platform using React, Node.js, MongoDB, and Google Maps API.</p>
				</article>
				<article className="flex-item">
					<h3>
						Github Searcher <small className="date">2020</small>
					</h3>
					<p>Developed a Redis-cached API integration app to explore GitHub users and repositories.</p>
				</article>
			{/* </div> */}
			{/* <div className="flex"> */}
				{/* <article className="flex-item">
